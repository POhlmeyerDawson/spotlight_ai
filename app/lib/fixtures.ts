...
> = {
    ...
    events: [
      {
        ...
        kind: "commit_burst",
        source: "github",
        source_url: "https://github.example.invalid/helix-rt/helix/commits/main",
      ...
      },
      {
        ...
        kind: "hn_post",
        source: "hn",
        source_url: "https://hn.example.invalid/item?id=helix-show-hn-v0-4",
        ...
        evidence_span:
          "You're right that the fsync path breaks determinism — here's a repro: https://github.example.invalid/helix-rt/helix/issues/88. We fixed it in 0.4.2 by routing every syscall through the shim. It was a real bug and your read of it was correct.",
        confidence: 0.91,
        integrity_flags: [],
        contribution: 6.8,
      },
      {
        ...
        kind: "release",
        source: "github",
        source_url: "https://github.example.invalid/helix-rt/helix/releases/tag/v0.4.2",
      ...
      },
      {
        ...
        kind: "deck_claim",
        source: "deck",
        source_url: "deck://helix-runtime.pdf#page=4",
        locator: "slide 4",
      ...
      },
      {
        ...
        kind: "green_flag",
        source: "validator",
        source_url: "https://github.example.invalid/helix-rt/helix/issues/88",
    ...
    claims: [
      {
        ...
        status: "verified",
        trust: 0.92,
        corroborating_url: "https://github.example.invalid/helix-rt/helix/blob/main/tests/test_determinism.py",
        corroborating_span:
  ...
  "anodyne-systems": {
    ...
    events: [
      {
        ...
        kind: "deck_claim",
        source: "deck",
        source_url: "deck://anodyne-systems.pdf#page=3",
        locator: "slide 3",
      ...
      },
      {
        ...
        kind: "green_flag",
        source: "web",
        source_url: "https://tecton.example.invalid/blog/feature-store-debugging/",
      ...
      },
      {
        ...
        source_url: "proof://pc-an-1#turn-2",
      ...
      },
      {
        ...
        kind: "proof_behavior",
        source: "proof_protocol",
        source_url: "proof://pc-an-1#turn-5",
    ...
    claims: [
      {
        ...
        status: "verified",
        trust: 0.84,
        corroborating_url: "proof://pc-an-1/artifact",
        corroborating_span:
    ...
    proof_protocol: {
      ...
      artifact_url: "proof://pc-an-1/artifact",
      behaviors: [
        {
    ...
    events: [
      {
        ...
        kind: "deck_claim",
        source: "deck",
        source_url: "deck://northwind-metrics.pdf#page=6",
        locator: "slide 6",
      ...
      },
      {
        ...
        kind: "contradiction",
        source: "hn",
        source_url: "https://hn.example.invalid/item?id=northwind-arr-thread",
      ...
      },
      {
        ...
        kind: "green_flag",
        source: "web",
        source_url: "https://a16z.example.invalid/usage-based-pricing/",
    ...
    claims: [
      {
        ...
        status: "contradicted",
        trust: 0.06,
        corroborating_url: "https://hn.example.invalid/item?id=northwind-arr-thread",
        corroborating_span:
          "We're pre-revenue right now — still figuring out whether to charge per seat or per call before we turn billing on.",
        self_published: true,
      ...
      },
      {
        ...
        status: "verified",
        trust: 0.81,
        corroborating_url: "https://a16z.example.invalid/usage-based-pricing/",
        corroborating_span:
          "Usage-based billing is now the default for API-first companies, and the metering layer is almost always built in-house and badly.",
        self_published: false,
        claim_asserted_at: "2025-11-20T00:00:00Z",
    ...
    events: [
      {
        ...
        kind: "commit_burst",
        source: "github",
        source_url: "https://github.example.invalid/vantage-grid/eval/commits/main",
      ...
      },
      {
        ...
        kind: "integrity",
        source: "deck",
        source_url: "deck://vantage-grid.pdf#page=7",
      ...
      },
      {
        ...
        kind: "deck_claim",
        source: "deck",
        source_url: "deck://vantage-grid.pdf#page=2",
        locator: "slide 2",
        observed_at: "2026-01-05T00:00:00Z",
      ...
      },
      {
        ...
        kind: "validation_result",
        source: "validator",
        source_url: "https://github.example.invalid/vantage-grid/eval",
        locator: "validator run 2026-01-09",
      ...
      },
      {
        ...
        kind: "green_flag",
        source: "web",
        source_url: "https://arxiv.example.invalid/abs/constructed-vantage-grid-2024-01",
        locator: "abstract",
    ...
    claims: [
      {
        ...
        status: "contradicted",
        trust: 0.03,
        corroborating_url: "https://github.example.invalid/vantage-grid/eval/commits/main",
        corroborating_span:
      ...
      },
      {
        ...
        status: "contradicted",
        trust: 0.01,
        corroborating_url: "https://integrity.example.invalid/vg-injection",
        corroborating_span:
    ...
    events: [
      {
        ...
        kind: "paper",
        source: "arxiv",
        source_url: "https://arxiv.example.invalid/abs/constructed-sparse-attn-2024-05",
      ...
      },
      {
        ...
        kind: "repo_activity",
        source: "github",
        source_url: "https://github.example.invalid/sarala/sparse-attn/commits/main",
      ...
      },
      {
        ...
        kind: "hn_comment",
        source: "web",
        source_url: "https://zenn.example.invalid/topics/cuda/articles/sparse-attn-review",
      ...
      },
      {
        ...
        kind: "green_flag",
        source: "web",
        source_url: "https://semianalysis.example.invalid/gpu-scarcity-2025/",
      ...
      },
      {
        ...
        kind: "green_flag",
        source: "validator",
        source_url: "https://github.example.invalid/sarala/sparse-attn/blob/main/bench/results.md",
    ...
    claims: [
      {
        ...
        status: "verified",
        trust: 0.89,
        corroborating_url: "https://zenn.example.invalid/topics/cuda/articles/sparse-attn-review",
        corroborating_span:
    ...
    events: [
      {
        ...
        kind: "profile_fact",
        source: "github",
        source_url: "https://github.example.invalid/kettle/flowd/commits/main",
      ...
      },
      {
        ...
        kind: "repo_activity",
        source: "github",
        source_url: "https://github.example.invalid/kettleworks/core/commits/main",
      ...
      },
      {
        ...
        kind: "deck_claim",
        source: "deck",
        source_url: "deck://kettleworks.pdf#page=5",
        locator: "slide 5",
    ...
    claims: [
      {
        ...
        status: "verified",
        trust: 0.9,
        corroborating_url: "https://github.example.invalid/kettle/flowd/commits/main",
        corroborating_span:
          "fix(scheduler): handle the DST rollover case reported in #412 — this has been wrong since 2019 and nobody hit it until Sunday.",
        self_published: false,
